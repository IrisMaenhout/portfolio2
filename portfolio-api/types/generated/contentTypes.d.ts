...
export interface ApiHeaderNavigationHeaderNavigation extends Schema.SingleType {
  ...
  attributes: {
    logoSite: Attribute.Component<'header-nav.logo-site'>;
    navItems: Attribute.Component<'header-nav.nav-items', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    projectUrls: Attribute.Component<'project-info.project-urls'>;
    projectCategories: Attribute.Relation<
      'api::project.project',
      'manyToMany',
